...
public class collection_reports_last_gift {
public WebDriver driver;
	
	public  collection_reports_last_gift(WebDriver driver) {
	...
	public WebElement collection_reports_last_gift() throws IOException {
		return driver.findElement(By.xpath(generic_library.access_properties_file(properties_file_path_collections.collection_reports_last_gift, "collection_reports_last_gift")));
	}
	
	public WebElement collection_reports_last_gift_title() throws IOException {
		return driver.findElement(By.xpath(generic_library.access_properties_file(properties_file_path_collections.collection_reports_last_gift, "collection_reports_last_gift_title")));
	}
